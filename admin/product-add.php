...
<head>
  <meta charset="utf-8">
    ...
    <title>Product | Bhavya Resources </title>
...
if(isset($_POST['submit'])) 
 ...
 $name =  $_POST['name'];
  $msg =  $_POST['msg'];
	...
	$sal=mysqli_query($con, "INSERT INTO `product`(`name`, `image`, `description`) VALUES  ('$name','$folder','$msg')");
				...
				<div class="col-lg-8 col-8">
					  <div class="box">
						...
						<form class="form" method="post" enctype="multipart/form-data">
							<div class="box-body">
								<h4 class="box-title text-info"><i class="ti-user mr-15"></i>Upload Product</h4>
								<hr class="my-15">
									<div class="row" >
							<div class="col-md-6">
