...
<head>
  <meta charset="utf-8">
    ...
    <title>Environment Report | Bhavya Resources </title>
...
if(isset($_POST['submit'])) 
	...
	$sal=mysqli_query($con, "INSERT INTO `environment_report`(`title`, `file`) VALUES ('$title','$folder')");

			if($sal)
			{
echo '<script>window.location="environment_report.php"</script>';
				...
				<div class="col-lg-8 col-8">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Environment Report </h4>
						</div>
			...
			<div class="col-lg-8 col-8">
				<div class="box">
					<div class="box-header">						
						<h4 class="box-title">View  Environment Report </h4>
					</div>
					<div class="box-body">
						<div class="table-responsive">
							<table id="complex_header" class="table table-striped table-bordered display" style="width:100%">
								...
								<tbody>
								   <?php
    $i = 0;
    $er = "SELECT * FROM `environment_report` ORDER BY id DESC";
   ...
   $i = $i + 1;
    ?>
									...
									<tr>
										...
										<td>
										<a href="environment_report_del.php?id=<?= $row['id'] ?>" 
